...
<div class="wp-block-query">
	<!-- wp:post-template -->
		...
		<div class="wp-block-group">
		<!-- wp:post-terms {"term":"category","prefix":"<?php echo esc_html__( 'Categories: ', 'advanced_theme' )?>"} /-->
		</div>
		<!-- /wp:group -->
		</div>
		<!-- /wp:group -->
	...
	<!-- wp:query-no-results -->
	<!-- wp:paragraph -->
	<p><?php esc_html_e( 'No results', 'advanced_theme' ); ?></p>
	<!-- /wp:paragraph -->
	<!-- /wp:query-no-results -->
	<!-- wp:query-pagination {"paginationArrow":"arrow","layout":{"type":"flex","justifyContent":"space-between"}} -->
	<!-- wp:query-pagination-previous {"label":"<?php esc_html_e( 'Previous', 'advanced_theme'); ?>"} /-->
	<!-- wp:query-pagination-next {"label":"<?php esc_html_e( 'Next', 'advanced_theme'); ?>"} /-->
	<!-- /wp:query-pagination -->
</div>
<!-- /wp:query -->
